...
Profile version:
`SCALPING_V1_20260919_R6_STOP75_TP40`
...
The previous pre-Sonar empirical profile failed positive-expectancy gates. It is not evidence of profitability and cannot unlock Demo. The R6 stop-bounded TP40 Sonar-locked profile requires a fresh validation artifact.

## PROMOTION ORDER
1. CI + runtime/public-stream smoke PASS.
2. Canonical forward PAPER chain PASS and accumulate sufficient telemetry.
3. Fresh R6 historical cost-stressed validation PASS.
